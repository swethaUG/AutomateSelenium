...
public class OrangeLinksCount {
	...
	public static void main(String[] args) {
		...
		System.out.println("Number of Links in Orangrhrm Login Page is);"+Links_count);
		for(WebElement Link:Links)
		{
			String Link_Names = Link.getText();
			System.out.println("Names of links in Orangehrm page is:"+Link_Names);
